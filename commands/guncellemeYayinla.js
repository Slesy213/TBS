...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const isOwner = app?.owner?.id === interaction.user.id || 
                    (app?.owner?.members && app.owner.members.has(interaction.user.id));
    const isDev = isOwner || DEV_IDS.includes(interaction.user.id);
